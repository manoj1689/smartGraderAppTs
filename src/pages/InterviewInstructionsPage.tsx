...
const InterviewInstructions: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="container lg:w-5/6 mx-auto w-full mt-24">
        <div className="flex rounded-md shadow-lg border border-solid m-4 border-black border-opacity-10 bg-white">
          <div className="w-full p-6">
            <h1 className="max-sm:text-2xl text-3xl font-bold  text-slate-800 mb-4">
              Interview Instructions (Please Read Carefully)
            </h1>
            <div className="flex w-full flex-col md:flex-row gap-6 my-4">
              <div className="space-y-4 w-full md:w-1/2 rounded-md border border-solid bg-sky-100 border-gray-300 p-6 shadow-sm">
                ...
                <p className="text-base text-slate-700">
                  <strong>Name:</strong> {interview?.title || "-"}
                </p>
                <p className="text-base text-slate-700">
              ...
              <div className="space-y-4 w-full md:w-1/2 rounded-md border border-solid border-gray-300 bg-sky-100 p-6 shadow-sm">
                ...
                <div className="space-y-2 text-base leading-6 text-slate-700 font-spline">
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      You will need to put on your camera throughout this
                      interview.
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      Before you start the interview you will need to give
                      browser access to your camera.
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-4 h-4 flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      You can listen to the questions and also record your
                      answers.
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      Be sure to enter the full-screen mode before starting the
                      interview.
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      Once you click Next, you cannot go back to the previous
                      page.
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <p>
                      Click the <strong>Start Interview</strong> button to
                      begin.
                    </p>
                  </div>
                </div>
            ...
            <div className="rounded-md border border-solid border-gray-300  shadow-sm bg-sky-100">
              <div>
                <BrowserInstructions />
              </div>
            </div>
            ...
            <div className="flex items-start mt-6  text-slate-700">
              ...
              <label htmlFor="disclaimer" className="ml-3 text-orange-700">
                ...
                Hardware allotted to me is in proper working condition. I agree
                that in case of not adhering to the instructions, I will be
                disqualified from taking the exam.
              </label>
            </div>

            <div className="flex flex-col lg:flex-row w-full mt-12 lg:w-5/6 mx-auto justify-center gap-4">
              <button
                type="button"
