  ...
  return (
    <div className="sm:p-4 w-full h-full">
      ...
      <form className="flex flex-col  xl:flex-row mt-10" onSubmit={handleSubmit}>
        <div className="flex w-full  xl:w-1/6 justify-center align-top">
        ...
        <div className="flex flex-col w-full xl:w-5/6">
          <div className="flex flex-col md:flex-row p-4">
            <div className="flex flex-col  pt-5 justify-center md:w-1/2">
              ...
              <div className="mt-2 w-full text-sm sm:text-lg leading-6 text-slate-800">
                <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="e.g.,John Wick" className="justify-center items-start p-3 mt-2 leading-4 rounded-md border border-solid border-neutral-400 w-full md:w-2/3 pr-10 focus:border-neutral-500 focus:ring-neutral-500 focus:outline-none" />
              </div>
              <div className="mt-5 sm:mt-10 w-full text-base font-light leading-6 text-neutral-500">Email Address</div>
              <div className="mt-2 w-full text-sm sm:text-lg leading-6 text-slate-800">
                <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="johnwick@gmail.com" className="justify-center items-start p-3 mt-2 leading-4 rounded-md border border-solid border-neutral-400 w-full md:w-2/3 pr-10 focus:border-neutral-500 focus:ring-neutral-500 focus:outline-none" />
              </div>
              <div className="mt-5 sm:mt-10 w-full text-base font-light leading-6 text-neutral-500">Phone</div>
              <div className="mt-2 w-full text-sm sm:text-lg leading-6 text-slate-800">
                <input type="tel" name="phone" placeholder="+91-8287000000" value={formData.phone} onChange={handleChange} className="justify-center items-start p-3 mt-2 leading-4 rounded-md border border-solid border-neutral-400 w-full md:w-2/3 pr-10 focus:border-neutral-500 focus:ring-neutral-500 focus:outline-none" />
              </div>
            </div>
            <div className="flex flex-col  pt-5 justify-center md:w-1/2">
          ...
          <div className="flex flex-col  p-4  gap-3 md:flex-row">
            <div className="flex flex-col   md:w-1/2 ">
              ...
              <div className="mt-2 w-full text-sm sm:text-lg leading-6 text-slate-800">
                <input type="password" name="oldPassword" value={formData.oldPassword} placeholder="1234567" onChange={handleChange} className="justify-center items-start p-3 mt-2 leading-4 rounded-md border border-solid border-neutral-400 w-full md:w-2/3 pr-10 focus:border-neutral-500 focus:ring-neutral-500 focus:outline-none" />
              </div>
            </div>
            <div className="flex flex-col  md:w-1/2">
              <div className="mt-5 sm:mt-10 w-full text-base font-light leading-6 text-neutral-500">New Password</div>
              <div className="mt-2 w-full text-sm sm:text-lg leading-6 text-slate-800">
                <input type="password" name="newPassword" placeholder="1234567" value={formData.newPassword} onChange={handleChange} className="justify-center items-start p-3 mt-2 leading-4 rounded-md border border-solid border-neutral-400 w-full md:w-2/3 pr-10 focus:border-neutral-500 focus:ring-neutral-500 focus:outline-none" />
              </div>
            </div>
          </div>
          <button type="submit" className="flex  justify-center sm:mx-4 my-10 max-md:mx-auto w-11/12  md:w-3/5  items-center self-stretch px-4 py-5 text-base text-white whitespace-nowrap bg-sky-500 rounded-md border border-sky-500 border-solid max-md:px-5">
