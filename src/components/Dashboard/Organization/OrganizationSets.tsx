      ...
      {currentItems.length > 0 ? (
        <div className="mt-8 justify-center ">
            ...
            {currentItems.map((card) => (
                ...
                <div
                className="flex flex-col my-4 p-4 mx-auto max-lg:w-72 w-full rounded-lg border border-violet-200 hover:border-gray-700 shadow-lg transition-transform transform hover:scale-105 duration-300 bg-white text-neutral-700"
                key={card.id}
              >
